                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <div className="flex items-center gap-3">
                            ...
                            {complaint.upvotes > 0 && (
                              <span className="px-1.5 py-0.5 rounded text-[9px] font-black bg-gov-saffron/10 text-gov-navy border border-gov-saffron/20 uppercase tracking-tighter">
                                +{complaint.upvotes} Citizen Reports
                              </span>
                            )}
                          </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                              <div className="space-y-8">
                                <div>
                                  ...
                                  <p className="text-gov-navy font-medium leading-relaxed mb-1">{complaint.text}</p>
                                  {complaint.status === 'Pending' && (
                                    <button 
                                      onClick={(e) => { e.stopPropagation(); handleDelete(complaint._id); }}
                                      className="px-4 py-2.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl font-bold text-xs uppercase tracking-widest transition-all border border-red-100 flex items-center gap-2 mt-4 cursor-pointer"
                                    >
