          ...
          <div style={{ marginTop: 'auto', paddingTop: '2rem', borderTop: '1px solid var(--gov-border)' }}>
            ...
            {(isAuthenticated || isDeptAuthenticated) ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <button onClick={() => handleViewChange('report')} className="btn-gov-primary" style={{ width: '100%', justifyContent: 'center' }}>Citizen Login</button>
                <button onClick={() => handleViewChange('dept-auth')} className="btn-gov-secondary" style={{ width: '100%', justifyContent: 'center' }}>Dept Portal</button>
              </div>
            )}
          </div>
        </div>
